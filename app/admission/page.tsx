  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-16 bg-white font-sans mt-10">
      ...
      <div className="text-center mb-16">
        <h1 className="text-4xl md:text-5xl font-extrabold text-blue-900 mb-4 tracking-tight">Admission Portal</h1>
      ...
      <div className="grid lg:grid-cols-3 gap-12">
        ...
        <div className="lg:col-span-2 space-y-10">
          ...
          <div className="bg-linear-to-br from-blue-900 to-indigo-900 rounded-3xl p-8 md:p-10 text-white shadow-xl relative overflow-hidden">
            <div className="relative z-10">
              ...
              <a 
                ...
                className="inline-flex items-center gap-2 bg-amber-500 hover:bg-amber-400 text-blue-950 font-extrabold px-10 py-4 rounded-xl transition-all transform hover:scale-105 shadow-2xl uppercase tracking-wider text-sm"
              >
                Open Google Form
              </a>
            </div>
          ...
          <section className="bg-white border border-gray-100 rounded-3xl p-8 shadow-sm">
            <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-3">
              <ClipboardCheck className="text-blue-600" size={28} /> Eligibility & Admission Rules
            </h2>
            <div className="prose prose-blue max-w-none text-gray-700">
              ...
              <div className="grid md:grid-cols-2 gap-6 mt-8 text-sm">
                ...
                <div className="space-y-4">
                  <h3 className="font-bold text-blue-900 flex items-center gap-2">
                    <Info size={18} className="text-blue-600" /> Important Terms
                  </h3>
                  <ul className="space-y-3 text-gray-600">
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-3">
              <FileCheck className="text-blue-600" size={28} /> Documents Required
            </h2>
            <div className="grid sm:grid-cols-2 gap-4">
              {documents.map((doc, i) => (
                <div key={i} className="flex items-start gap-4 p-5 bg-blue-50/50 border border-blue-100 rounded-2xl transition-all hover:bg-blue-50">
                  <div className="h-10 w-10 bg-white text-blue-600 rounded-xl shadow-sm flex items-center justify-center shrink-0 font-bold">
                    {i + 1}
                  </div>
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-xl">
            ...
            <p className="text-gray-600 text-sm mb-6 leading-relaxed">
              ...
              <br /><br />
              <span className="font-bold text-blue-900">Registration Fee: Rs 50/-</span>
            </p>
            ...
            <div className="bg-gray-50 rounded-2xl p-6 border-2 border-dashed border-gray-200 text-center">
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="w-full inline-flex items-center justify-center gap-2 bg-white border border-gray-200 hover:border-blue-600 hover:text-blue-600 text-gray-700 font-bold py-3 rounded-xl transition-all shadow-sm group"
              >
          ...
          {/* Quick Help Card */}
          <div className="p-8 bg-blue-900 rounded-3xl text-white shadow-lg relative overflow-hidden">
